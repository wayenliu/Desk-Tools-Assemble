...
CGridCtrl * CGridCell::GetParentGridCtl()
{
	m_pParentGridCtl = m_pGrid;
	return m_pParentGridCtl;
}

CGridCellProvider * CGridCell::GetCellProvider()
{
	if (NULL == m_pGridCellProvider)
	{
		m_pGridCellProvider = new CGridCellProvider(this);
	}
	return m_pGridCellProvider;
}